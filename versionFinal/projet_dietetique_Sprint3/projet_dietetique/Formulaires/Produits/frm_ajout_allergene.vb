''' <summary>
'''  formulaire affichant le contenu du contrôle utilisateur usr_ajout_allergene.
'''   fait par Sébastien Poulain
''' </summary>
''' <tag>2019</tag>
Public Class frm_ajout_allergene

    Dim AjoutAllergene As New usr_ajout_allergene
    Private Sub frm_ajout_allergene_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Panel1.Controls.Add(AjoutAllergene)
        Me.CenterToScreen()
    End Sub
    ''' <summary>
