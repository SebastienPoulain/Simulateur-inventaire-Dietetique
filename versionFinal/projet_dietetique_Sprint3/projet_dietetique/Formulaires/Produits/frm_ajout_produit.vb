''' <summary>
'''  formulaire affichant le contenu du contrôle utilisateur usr_ajout_produit.
'''   fait par Sébastien Poulain
''' </summary>
''' <tag>2019</tag>
Public Class frm_ajout_produit
    Dim usrAjoutProduit As New usr_ajout_produit()
    Private Sub frm_ajout_produit_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        PanelAjoutProduit.Controls.Add(usrAjoutProduit)
    End Sub
    ''' <summary>
    ...
    Private Sub btn_exit_Click(sender As Object, e As EventArgs) Handles btn_exit.Click
        'vide la liste d'allergènes si on quitte en utilisant le bouton btn_exit.
        usrAjoutProduit.clearList()
        Me.Close()
    End Sub
    ''' <summary>
