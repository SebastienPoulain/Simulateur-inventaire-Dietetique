''' <summary>
'''  formulaire affichant le contenu du contrôle utilisateur usr_historique_taxes.
'''   fait par Sébastien Poulain
''' </summary>
''' <tag>2019</tag>
Public Class frm_historique_taxes
    Dim usr_historique As New usr_historique_taxes
    Private Sub frm_historique_taxes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Panel1.Controls.Add(usr_historique)
        Me.CenterToScreen()
    End Sub
    ''' <summary>
